...
// button controls   9-30 2056 pseudo code
up.addEventListener("click", butControl)
right.addEventListener("click", butControl)
down.addEventListener("click", butControl)
left.addEventListener("click", butControl)
...
// optimistically adding mobile event listeners
